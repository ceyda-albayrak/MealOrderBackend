...
{
    public class DapOrderDetailManager : IDapOrderDetailService
    {
        private IDapOrderDetailDal _orderDetailDal;
        public DapOrderDetailManager(IDapOrderDetailDal orderDetailDal)
        {
