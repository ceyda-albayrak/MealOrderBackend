...
{
    public class DapProductManager : IDapProductService
    {
        private IDapProductDal _productDal;
        private IDapCategoryDal _categoryDal;
        private IDapRestaurantInfoDal _infoDal;
        public DapProductManager(IDapProductDal productDal, IDapCategoryDal categoryDal, IDapRestaurantInfoDal infoDal)
        {
