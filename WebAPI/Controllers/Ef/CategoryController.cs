...
namespace WebAPI.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        private IDapCategoryService _dapCategory;
        private IWebHostEnvironment env;

        public CategoryController(ICategoryService categoryService,IDapCategoryService dapCategory,IWebHostEnvironment env)
        {
            _categoryService = categoryService;
            _dapCategory = dapCategory;
            env = env;
        }
