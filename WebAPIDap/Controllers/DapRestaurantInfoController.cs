...
namespace WebAPI.Controllers.Dap
{
    ...
    [ApiController]
    public class DapRestaurantInfoController : Controller
    {
        private IDapRestaurantInfoService _infoService;

        public DapRestaurantInfoController(IDapRestaurantInfoService infoService)
        {
